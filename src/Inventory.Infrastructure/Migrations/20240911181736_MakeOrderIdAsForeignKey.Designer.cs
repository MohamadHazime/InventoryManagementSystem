...
namespace Inventory.Infrastructure.Migrations
{
    ...
    [Migration("20240911181736_MakeOrderIdAsForeignKey")]
    partial class MakeOrderIdAsForeignKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Domain.AggregatesModel.ItemLedgerAggregate.ItemLedger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventory.Domain.AggregatesModel.OrderAggregate.Order", b =>
                {
                    b.HasOne("Inventory.Domain.AggregatesModel.SupplierAggregate.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("Inventory.Domain.AggregatesModel.ReceiptAggregate.Receipt", b =>
                {
                    b.HasOne("Inventory.Domain.AggregatesModel.OrderAggregate.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
